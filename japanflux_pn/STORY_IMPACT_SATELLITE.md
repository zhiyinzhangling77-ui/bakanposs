...
- **陸の生態系は人為CO₂の約3割を吸収**（GCB2024：2014–2023で30%／IPCC AR6 WG1 Ch5：2010–2019で31%）。
  **この陸のシンクの将来が"炭素循環予測の鍵の不確実性"**：陸のカーボン–気候フィードバックは
  **−45.1 ± 50.6 PgC °C⁻¹**（海の約3倍、ばらつきも桁違い）（Arora et al. 2020）。
  なかでも**光合成代謝の温度感度が最大の不確実要素**（Booth et al. 2012）。
  ※IPCC AR6 Ch5 は「2100年CO₂の不確実性は炭素–気候フィードバックより人為排出量が支配（high confidence）」
  とも述べる＝「気候予測"全体"の最大不確実性」とは言わず「炭素循環の中で陸が鍵」と述べる。
