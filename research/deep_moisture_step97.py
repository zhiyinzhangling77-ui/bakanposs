...
def main():
    ...
    print("   ・**副検定には対照が無い**（春の中だけで秋を使わない）。")
    print("     **代わりに合成 `shallow` で「浅層を拾わない」ことを確かめてある**が、")
    print("     **主検定の門①ほど強くはない**。")
    print("   ・**重なり帯という道具は、“群間で違う量”を揃えるのに使うと自己矛盾する**——")
    print("     **旗90(Ts)・旗95(GCC)・旗96(VPD) の「判定しない」の一部も、")
    print("     この構造による可能性がある。**")
